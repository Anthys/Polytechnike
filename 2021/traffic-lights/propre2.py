    ...
    for i, street in enumerate(streets):
        ...
        for trajet in trajets_voitures:
            if nom in trajet: 
                ...
                if min_tailles_itineraires <= taille_itineraire(trajet) <= mean_tailles_itineraires:
                  compteur += np.mean(densities_list)*(mean_tailles_itineraires-taille_itineraire(trajet))/(mean_tailles_itineraires-min_tailles_itineraires)
                else: compteur += 1
